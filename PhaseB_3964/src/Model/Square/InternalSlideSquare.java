...
/**
 * This class creates a new internal slide square of the board.
 * @author 3964
 */
public class InternalSlideSquare extends SlideSquare {
	...
	/**
	 * <Constructor> 
	 * <Postcondition> : creates a new internal slide square for player p and
	 * sets it's image, with command  super , to parent class SlideSquare.
	 * @param image
	 * @param color
	 */
	public InternalSlideSquare(Color color, ImageIcon image) {
		super(color, image);
	}
