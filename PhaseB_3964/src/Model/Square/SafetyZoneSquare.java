...
/**
 * This class creates a new safety zone square of the board.
 * @author 3964
 */
public class SafetyZoneSquare extends Square {
	...
	/**
	 * <Constructor> 
	 * <Postcondition> : creates a new safety zone square for player p and
	 * sets it's image, with command  super , to parent class Square.
	 * @param image
	 * @param color
	 */
	public SafetyZoneSquare(Color color, ImageIcon image) {
		super(color, image);
	}
