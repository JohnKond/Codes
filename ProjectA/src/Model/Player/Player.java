...
public class Player {
	...
	public void initializePawns(Color color,Player player,Square square[][]) {
		if (color == Color.red) {
			pawn1 = new Pawn(square[1][3],player,1,new ImageIcon("C:/Users/ΓΚΕΙ/Desktop/images/pawns/redPawn1.png"));
			pawn2 = new Pawn(square[1][4],player,2,new ImageIcon("C:/Users/ΓΚΕΙ/Desktop/images/pawns/redPawn2.png"));
		}else {
			pawn1 = new Pawn(square[14][11],player,1,new ImageIcon("C:/Users/ΓΚΕΙ/Desktop/images/pawns/yellowPawn1.png"));
			pawn2 = new Pawn(square[14][12],player,2,new ImageIcon("C:/Users/ΓΚΕΙ/Desktop/images/pawns/yellowPawn2.png"));
		}
	}
